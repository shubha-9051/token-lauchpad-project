...
export function TokenLaunchpad() {
    ...
    async function createToken() {
        ...
        const metadata = {
            ...
            symbol: document.getElementById('SMBL').value,
        ...
        const transaction3 = new Transaction().add(
            createMintToInstruction(mintKeypair.publicKey, associatedToken, wallet.publicKey, parseFloat(document.getElementById("SUPPLY").value)*1000000000, [], TOKEN_2022_PROGRAM_ID)
        );
    ...
    return <div style={{
        ...
        <input className='inputText' type='text' placeholder='Name' id="TOKEN_NAME"></input> <br />
        <input className='inputText' type='text' placeholder='Symbol' id="SMBL"></input> <br />
        <input className='inputText' type='text' placeholder='Image URL' id="URI"></input> <br />
